...
echo %RED%!FS0_TXT_HDR_CLEAN!%RESET%
set "BUILD_DIR=%SCRIPT_DIR%Firestorm_Build"

echo %RED%!FS0_TXT_DELETE_BUILD!%RESET%
if exist "%BUILD_DIR%" (
    rmdir /s /q "%BUILD_DIR%"
    echo %RED%!FS0_TXT_OK_DELETED! "%BUILD_DIR%"%RESET%
) else (
    echo %RED%!FS0_TXT_INFO_NOT_EXIST! "%BUILD_DIR%"%RESET%
)

echo %RED%!FS0_TXT_DONE!%RESET%
:: pause